...
/** Create or overwrite table entry
...
/**
   ...
   If output value==NULL and return==true,
   this means that the key exists but the value is NULL
*/
...
size_t table_tostring(char* output, size_t size,
